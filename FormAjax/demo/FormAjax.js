...
function check_format_username() {
    var txt_username = document.getElementById("user_name").value;
    if (txt_username != "") {
        if(txt_username.length < 8) {
            document.getElementById("username_error").innerText = "Username length min 8 letters";
        }
        else{
...
function check_format_password() {
    var txt_password = document.getElementById("password").value;
    if (txt_password != "") {
        if(txt_password.length < 8) {
            document.getElementById("password_error").innerText = "Password length min 8 letters";
        }
        else {
...
function check_format_email() {
    ...
    if (txt_email != ""){
        if(txt_email.includes("@") && txt_email.includes(".com")) {
            document.getElementById("email_error").innerText = " ";
        }
        else
            document.getElementById("email_error").innerText = " Email wrong format ";
    }
}
